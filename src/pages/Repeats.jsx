            ...
            <div key={cluster.id} className="cluster-card glass-card">
              ...
              <div className="cluster-questions">
                {cluster.questions.map((q) => (
                  ...
                  {q.solution && (
                    <details className="q-solution-box" style={{ marginTop: '0.75rem', marginBottom: '0.5rem' }}>
                  ...
                  {q.quickTip && (
                    <details className="q-quicktip-box" style={{ marginTop: '0.5rem', marginBottom: '0.5rem' }}>
